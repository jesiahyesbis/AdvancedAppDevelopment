...
const Placeorder = () => {
  ...
  const giftOptions = [
    { name: 'Birthday Party', price: '$25' },
    { name: 'Baby Shower', price: '$30' },
    { name: 'Housewarming Party', price: '$50' },
    { name: 'Bachelorette Party', price: '$15' },
    { name: 'Thanks Giving', price: '$40' },
    { name: 'Anniversary', price: '$60' },
  ...
  return (
    <div className="container mx-auto px-4 py-8 h-screen overflow-y-auto">
      <h1 className="text-3xl font-semibold mb-4">Place Your Bookings</h1>
      <form onSubmit={handleSubmit}>
        ...
        <div className="mb-4">
          <label htmlFor="gift" className="block text-gray-700 text-sm font-bold mb-2">Select Event</label>
          <select
            id="gift"
            name="selectedGift"
            value={selectedGift}
        ...
        <div className="mt-8">
          ...
          <table className="table-auto border-collapse border border-green-800">
            <tbody>
              ...
              <tr>
                <td className="border border-green-600 px-4 py-2"><strong>Selected Event:</strong></td>
