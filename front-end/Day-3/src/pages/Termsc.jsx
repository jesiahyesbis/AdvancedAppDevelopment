    ...
    <div className="bg-gray-100 min-h-screen flex flex-col justify-center items-center py-10">
      <div className="max-w-3xl mx-auto p-8 bg-white shadow-lg rounded-lg">
        ...
        <div className="term-section bg-gradient-to-b from-purple-200 to-purple-300 rounded-lg p-6 mb-6 hover:bg-purple-300 hover:text-white focus:bg-purple-300 focus:text-white active:bg-purple-400">
          ...
          <p className="text-lg">
            By accessing or using the Party Pro Website, you agreed to be bound by these Terms and Conditions and all applicable laws and regulations governing the App. If you do not agree with any of these terms, you are prohibited from using or accessing the App.
          </p>
        </div>
        <div className="term-section bg-gradient-to-b from-blue-200 to-blue-300 rounded-lg p-6 mb-6 hover:bg-blue-300 hover:text-white focus:bg-blue-300 focus:text-white active:bg-blue-400">
          ...
          <p className="text-lg">
            The App provides users with the ability to book parties for various occasions. Users may also view their order history, manage their account settings, and contact customer support.
          </p>
        </div>
        ...
        <div className="term-section bg-gradient-to-b from-yellow-200 to-yellow-300 rounded-lg p-6 mb-6 hover:bg-yellow-300 hover:text-white focus:bg-yellow-300 focus:text-white active:bg-yellow-400">
          ...
          <p className="text-lg">
            Party Pro shall not be liable for any direct, indirect, incidental, special, or consequential damages arising out of the use or inability to use the App, even if Party Pro has been advised of the possibility of such damages.
          </p>
        </div>
