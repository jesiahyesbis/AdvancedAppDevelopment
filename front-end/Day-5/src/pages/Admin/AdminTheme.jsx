...
const AdminTheme = () => {
  const [giftIdeas, setGiftIdeas] = useState([
    { id: 1, theme: 'Elegant', details: 'Birthday Party', price: '$49.99' },
    { id: 2, theme: 'Romantic', details: 'Thanks Giving', price: '$39.99' },
    { id: 3, theme: 'Classic', details: 'Baby Shower', price: '$59.99' },
  ]);
