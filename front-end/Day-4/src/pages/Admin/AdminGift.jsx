...
const AdminGift = () => {
  const [giftIdeas, setGiftIdeas] = useState([
    { id: 1, name: 'Birthday Party', image: 'https://m.media-amazon.com/images/I/81DXhu6ONML.jpg', price: '$49.99', theme: 'Elegant' },
    { id: 2, name: 'Baby Shower', image: 'https://m.media-amazon.com/images/I/71IC2lqIgdL._AC_UF1000,1000_QL80_.jpg', price: '$39.99', theme: 'Romantic' },
    { id: 3, name: 'Thanks Giving', image: 'https://cdn.cdnparenting.com/articles/2018/12/14121244/1143416498-H-1024x700.webp', price: '$59.99', theme: 'Classic' },
  ]);
  ...
  return (
    <main className="p-4">
      <div className="bg-grey-400 rounded-lg shadow-md p-6">
        <h2 className="text-xl font-bold mb-4">ADMIN EVENTS</h2>
        <div className="mb-4">
          <input
            type="text"
            className="border rounded-md p-2 mr-2"
            placeholder="Enter new event idea"
            value={newGiftName}
